...
public class Ex_Obj_04 {
	public static void main(String[] args) {
			Figure1[] fig = new Figure1[2];
			fig[0] = new Circle3("원",5,1,1);
			fig[1] = new Rectangle3("사각형",1,4,3,7);
			// x1, y1, x2, y2
			// 3-1=2 가로  7-4=3 세로
			for(Figure1 f : fig) {
...
abstract class Figure1{
	String type;
	public Figure1(String type) {
		this.type = type;	}
	abstract double area();
	abstract double length();		}

class Circle3 extends Figure1{
	int r;
	Point1 p;
	public Circle3(String type, int r, int x, int y) {
		super(type);	this.r=r;
		p = new Point1(x,y); 	}
	@Override
	double area() {
...
class Rectangle3 extends Figure1{
	Point1 p1,p2;
	public Rectangle3(String type,int x1,int y1,int x2, int y2) {
		super(type);
		p1 = new Point1(x1, y1);
		p2 = new Point1(x2, y2);}
