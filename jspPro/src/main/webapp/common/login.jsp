...
<div class="w3-bar w3-light-grey">
 ...
 <%} else { %>
     <a href="${pageContext.request.contextPath }/member/memberinfo" class="w3-bar-item w3-button w3-hide-small">회원정보확인[<%=session.getAttribute("id")%>]</a>
 ...
 <%String admin = (String)session.getAttribute("id");
 	...
 	<a href="${pageContext.request.contextPath }/member/memberList" class="w3-bar-item w3-button w3-hide-small">회원정보</a>
 	<%} %>
